...
The architecture used in the project is the **MVCS (Models Views Controllers Services)**. The official project is working commercially. You can visit it by this link: <a href="https://sweet-d.herokuapp.com/"></a>
