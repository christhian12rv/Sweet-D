...
The architecture used in the project is the **MVCS (Models Views Controllers Services)**. The new version of the project (optmized and new design) is on branch "client-refactoring".
